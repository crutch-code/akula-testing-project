                ...
                <div className="row mb-5">
                    {Array.from({ length: 15 }).map(() =>
                        <News newsId={3} title='Akulaplay - магазин с душой.'
                            ...
                            Мы - команда, которая профессионально улучшает Ваше впечатление от собственного авто!
                            Более 5 лет мы помогаем нашим клиентам сделать правильный выборр и подбираем для их авто
                            автомагнитолы на андроид, акустические системы и автоэлектронику.
                            Наши клиенты часто говорят "Ваа-у!" после преображения их авто! В 100% случаев изменения
